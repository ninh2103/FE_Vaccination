      ...
      <div className='max-w-[70rem] mx-auto p-5'>
        ...
        <div className='max-w-[70rem] mx-auto my-4 bg-white shadow-lg rounded-lg overflow-hidden'>
          <div className='bg-blue-600 p-4'>
            {/* <h2 className="text-white font-bold text-lg">Thông báo sức khỏe</h2> */}
          </div>
        ...
        <div className='my-4'>
          <img
            src='https://vnvc.vn/wp-content/uploads/2025/02/khoi-sot-xuat-huyet-bao-lau-thi-duoc-tam.jpg'
            alt='Blog visual'
        ...
        <div className='my-4'>
          <img
            src='https://vnvc.vn/wp-content/uploads/2024/09/banner-post-vac-xin-sot-xuat-huyet.jpg'
            alt='Blog visual'
            className='w-full h-auto'
          />
        </div>
        ...
        <div className='my-4'>
          {' '}
          <img
            src='https://vnvc.vn/wp-content/uploads/2025/02/sau-khi-het-sot-xuat-huyet-co-duoc-tam-khong.jpg'
            alt='Blog visual'
            className='w-full h-auto'
          />
        </div>
        ...
        <div className='my-4'>
          {' '}
          <img
            src='https://vnvc.vn/wp-content/uploads/2025/02/het-sot-xuat-huyet-bao-lau-thi-duoc-tam.jpg'
            alt='Blog visual'
            className='w-full h-auto'
          />
        </div>
        ...
        <p>
          ...
          <div className='my-4'>
            {' '}
            <img
              src='https://vnvc.vn/wp-content/uploads/2025/02/bo-sung-dinh-duong-sau-khi-het-sot-xuat-huyet.jpg'
              alt='Blog visual'
              className='w-full h-auto'
            />
          </div>
