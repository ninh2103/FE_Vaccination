...
const VaccinePrices: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 p-6 rounded-lg shadow-lg max-w-7xl mx-auto px-4">
      <div className="flex justify-center items-center">
        <h2 className="text-5xl font-extrabold text-transparent bg-gradient-to-r from-teal-400 to-teal-800 mb-6 pb-2 bg-clip-text border-b-4 border-teal-600 inline-block shadow-lg">
          Bảng Giá Tiêm Chủng VAX-BOX
        </h2>
      </div>
      <p className="text-lg text-gray-800 text-center mb-8">
        Bảng giá tiêm chủng VAX-BOX được niêm yết công khai, cam kết bình ổn giá trên toàn hệ thống, miễn phí khám và nhiều tiện ích.
      </p>
      ...
      <div className="mb-6 relative overflow-hidden rounded-xl shadow-xl flex justify-center items-center">
        <img
          ...
          alt="Vắc-xin"
          className="w-[80%] h-[200px] object-cover rounded-xl transition-all duration-500 ease-in-out transform hover:scale-105 hover:opacity-90"
        />
      ...
      <h2 className="text-3xl font-bold mb-8 text-left text-teal-700" id="price-list">Danh sách Bảng Giá Vắc-Xin</h2>
              ...
              {currentVaccines.map((vaccine, index) => (
                <tr key={vaccine.id} className="hover:bg-teal-100">
                  ...
                  <td className="border-b px-6 py-4">
                    <span
                      className={`${
                        vaccine.status === 'Còn hàng' ? 'text-green-600' : 'text-red-600'
                      } font-semibold`}
                    >
                      {vaccine.status}
                    </span>
  ...
  <ul className="list-decimal pl-6 mt-4 space-y-4 max-w-4xl mx-auto text-left">
    ...
    <li className="text-lg text-gray-700 hover:text-teal-600 transition-colors duration-300 ease-in-out">
      <span className="font-semibold">Giá vắc xin tại VAX-BOX đã bao gồm:</span> miễn phí khám với đội ngũ bác sĩ chuyên môn cao, miễn phí các dịch vụ chăm sóc Khách hàng cao cấp; phí cho tài liệu, ấn phẩm phục vụ Khách hàng; chi phí cuộc gọi, tin nhắn (SMS) nhắc lịch tiêm vắc xin; phí chăm sóc Khách hàng trên đa nền tảng; phí lưu trữ thông tin lịch sử tiêm chủng…
    </li>
    <li className="text-lg text-gray-700 hover:text-teal-600 transition-colors duration-300 ease-in-out">
      <span className="font-semibold">VAX-BOX miễn phí đặt giữ theo yêu cầu tất cả các loại vắc xin, tiêm bằng giá lẻ nếu Quý Khách hoàn tất lịch tiêm trong vòng 5 tuần.</span> Quý Khách có lịch tiêm sau 5 tuần, phí đặt giữ vắc xin được tính 20% trên giá lẻ hoặc giá lẻ đã được ưu đãi.
    </li>
    <li className="text-lg text-gray-700 hover:text-teal-600 transition-colors duration-300 ease-in-out">
      <span className="font-semibold">VAX-BOX miễn phí bảo quản vắc xin trong hệ thống kho lạnh GSP theo tiêu chuẩn quốc tế, hệ thống dây chuyền lạnh Cold Chain,</span> đảm bảo vắc xin an toàn, chất lượng cao ở tất cả các trung tâm trên toàn quốc.
    </li>
  </ul>
</div>
...
<div id="vaccine-services" className="mt-12 text-lg text-gray-800">
  ...
  <h3 className="text-xl font-extrabold text-teal-700 mb-4 text-left text-shadow-md ml-4">Các Dịch Vụ Tiêm Chủng tại VAX-BOX</h3>

  <p className="max-w-4xl mx-auto text-left">
    VAX-BOX mang đến cho quý khách hàng nhiều dịch vụ tiêm chủng linh hoạt, đáp ứng nhu cầu bảo vệ sức khỏe cho từng đối tượng:
  </p>

  <ul className="list-disc pl-5 mt-4 space-y-2 max-w-4xl mx-auto text-left">
    <li><strong>Tiêm lẻ tất cả các loại vắc-xin:</strong> Bạn có thể tiêm riêng từng loại vắc-xin theo nhu cầu.</li>
    <li><strong>Gói vắc-xin theo độ tuổi:</strong> Gói vắc-xin cho trẻ dưới 24 tháng, trẻ tiền học đường, trẻ vị thành niên và thanh niên, phụ nữ chuẩn bị mang thai, người trưởng thành…</li>
    <li><strong>Gói vắc-xin cá thể hóa:</strong> Khách hàng có thể linh động lựa chọn vắc-xin thiết kế thành các gói riêng biệt tùy theo nhu cầu, độ tuổi và khả năng chi trả.</li>
    <li><strong>Đặt giữ vắc-xin theo yêu cầu:</strong> Quý khách có thể đặt giữ vắc-xin theo yêu cầu với nhiều ưu đãi hấp dẫn.</li>
    <li><strong>Tiêm chủng lưu động:</strong> Chúng tôi cung cấp dịch vụ tiêm chủng lưu động, theo yêu cầu đối với các nhóm khách hàng, cơ quan, doanh nghiệp.</li>
  </ul>
</div>
...
<div id="vaccine-packages" className="mt-12 text-lg text-gray-800">
  ...
  <h3 className="text-xl font-extrabold text-teal-700 mb-4 text-left text-shadow-md ml-4">Các Gói Tiêm Vắc-Xin</h3>
  
  <p className="max-w-4xl mx-auto text-left">
    Chúng tôi cung cấp các gói tiêm vắc-xin với nhiều lựa chọn khác nhau để bạn có thể bảo vệ sức khỏe cho bản thân và gia đình. Dưới đây là một số gói vắc-xin bạn có thể tham khảo:
  </p>
  ...
  <h4 className="font-semibold mt-6 text-left text-teal-600 text-lg font-bold ml-4" id="pre-school-vaccine">Gói vắc xin cho trẻ tiền học đường</h4>
  <p className="max-w-4xl mx-auto text-left">
    Gói tiêm chủng VNVC cho trẻ tiền học đường bao gồm 10 loại vắc xin, 14 liều cơ bản bảo vệ trẻ trước hơn 20 căn bệnh truyền nhiễm nguy hiểm.
  </p>

  {/* Tiêu đề của gói vắc-xin cho tuổi vị thành niên và thanh niên */}
  <h4 className="font-semibold mt-6 text-left text-teal-600 text-lg font-bold ml-4" id="teenage-vaccine">Gói vắc xin cho tuổi vị thành niên và thanh niên (Từ 9 – 18 tuổi)</h4>
  <p className="max-w-4xl mx-auto text-left">
    Gói tiêm chủng VNVC cho tuổi vị thành niên và thanh niên bao gồm 15 mũi tiêm cho gần 20 bệnh truyền nhiễm nguy hiểm. Có 2 gói nhỏ cho khách hàng lựa chọn: vắc xin Gardasil và Gardasil 9.
  </p>

  {/* Tiêu đề của gói vắc-xin cho người trưởng thành */}
  <h4 className="font-semibold mt-6 text-left text-teal-600 text-lg font-bold ml-4" id="adult-vaccine">Gói vắc xin cho người trưởng thành</h4>
  <p className="max-w-4xl mx-auto text-left">
  ...
  <h4 className="font-semibold mt-6 text-left text-teal-600 text-lg font-bold ml-4" id="pregnant-vaccine">Gói vắc xin cho phụ nữ chuẩn bị mang thai</h4>
  <p className="max-w-4xl mx-auto text-left">
  ...
  <h4 className="font-semibold mt-6 text-left text-teal-600 text-lg font-bold ml-4">Gói vắc xin cá thể hóa cho người trưởng thành</h4>
  <p className="max-w-4xl mx-auto text-left">
    Gói vắc xin cá thể hóa cho người trưởng thành là gói vắc xin có thể lựa chọn theo nhu cầu, như các bệnh dịch đặc thù hoặc yêu cầu riêng của từng cá nhân.
  </p>
</div>

{/* Dịch vụ tiêm chủng lưu động theo yêu cầu */}
<div className="mt-12 text-lg text-gray-800">
  <h3 className="text-xl font-extrabold text-teal-700 mb-4 text-left text-shadow-md ml-4">Dịch Vụ Tiêm Chủng Lưu Động Theo Yêu Cầu</h3>
  <p className="max-w-4xl mx-auto text-left">
    Sau đại dịch Covid-19, người dân đã ý thức hơn về tầm quan trọng và vai trò của vắc xin đối với sức khỏe. Nhu cầu tiêm chủng của người dân ngày càng cao, đặc biệt là các doanh nghiệp sản xuất, kinh doanh có dây chuyền vận hành nhiều khâu chuỗi liên đới, quy mô nhân sự lớn, tần suất và tỷ lệ tiếp xúc giữa người – người diễn ra rất cao trong môi trường làm việc. Không tiêm vắc xin cũng đồng nghĩa với việc mất đi một lớp “lá chắn” vững chãi, nguy cơ mắc bệnh tăng cao, sức khỏe người lao động bị ảnh hưởng dẫn đến đứt gãy chuỗi cung ứng.
  </p>
  <p className="max-w-4xl mx-auto text-left mt-4">
    Để bảo vệ sức khỏe cho người lao động, đảm bảo quá trình sản xuất không bị ảnh hưởng, Hệ thống tiêm chủng VAX-BOX mang đến giải pháp tiêm chủng lưu động theo yêu cầu của Khách hàng, như tiêm chủng cá nhân, cơ quan, doanh nghiệp, trường học… giúp thuận tiện, tiết kiệm thời gian và chi phí tiêm chủng.
  </p>
</div>
