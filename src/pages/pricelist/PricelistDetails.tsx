...
const VaccinePrices: React.FC = () => {
  ...
  return (
    <div className='bg-gray-50 p-6 rounded-lg shadow-lg max-w-7xl mx-auto px-4'>
      ...
      <h2 className='text-3xl font-bold mb-8 text-left text-teal-700' id='price-list'>
      ...
      <div id='vaccine-services' className='mt-12 text-lg text-gray-800'>
        ...
        <h3 className='text-xl font-extrabold text-teal-700 mb-4 text-left text-shadow-md ml-4'>
