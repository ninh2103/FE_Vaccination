  ...
  return (
    <div className=' container mt-11 mb-24 lg:mb-32 flex flex-col lg:flex-row lg:justify-end lg:gap-10'>
      ...
      <div className='w-full lg:w-3/5 xl:w-2/3 lg:ml-96 lg:max-w-[600px]'>
        <Card>
          <CardContent className='space-y-8 p-6 xl:p-8 dark:bg-gray-900'>
      ...
      <div className='w-full lg:w-2/5 xl:w-1/3 lg:mr-auto'>
        <Card>
          <CardContent className=' dark:bg-gray-900 space-y-6 sm:space-y-8 p-6 xl:p-8'>
            <div className='flex flex-col sm:flex-row sm:items-center'>
              ...
              <div className='py-5 sm:px-5 space-y-3'>
                <span className=' dark:text-neutral-400 line-clamp-1 text-base font-bold mt-1 block'>
                  Tuberculosis Vaccine
                </span>
                <span className='text-base font-thin mt-1 block'>
