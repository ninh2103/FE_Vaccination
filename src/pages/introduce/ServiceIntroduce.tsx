  ...
  return (
    <div className='bg-gray-10 min-h-screen py-0 px-6'>
      ...
      <main className='flex flex-col items-center justify-center bg-gray-50 pt-36 pb-10 px-10'>
        ...
        <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
          <h2 className='text-4xl font-extrabold text-blue-800 mb-6 text-left'>Quy Trình Tiêm Chủng Đạt Chuẩn</h2>
          ...
          <h3 className='text-2xl font-semibold text-blue-800 mb-4 text-left'>
        ...
        <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
          ...
          <p className='text-lg text-gray-700 leading-relaxed mb-4'>
            ...
            nghiêm ngặt nhằm đảm bảo tính an toàn ở mức tối đa. Tại mỗi trung tâm Vax-box đều có phòng xử trí phản ứng
            sau tiêm với đầy đủ trang thiết bị theo tiêu chuẩn của Bộ Y tế.
          </p>
          <p className='text-lg text-gray-700 leading-relaxed mb-4'>
        ...
        <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
          <h2 className='text-3xl font-extrabold text-blue-800 mb-6 text-left'>Tại sao chọn chúng tôi ?</h2>
