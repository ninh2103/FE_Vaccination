...
import Options from '@/pages/introduce/banner'
        ...
        <main className='flex flex-col items-center justify-center bg-gradient-to-r from-blue-100 via-green-50 to-teal-100 pt-4 pb-10 px-10'>
          ...
          <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
            <p className='text-lg text-gray-700 leading-relaxed mb-4 mt-6 text-center italic'>
              ...
              globally, Vax-box was born as an inevitable trend of development, with the goal of contributing to
              repelling and eliminating the epidemic at the present time, as well as improving the quality of life for
              Vietnamese people in the future.
            </p>
            ...
            <p className='text-lg text-gray-700 leading-relaxed mb-4 mt-6'>
              ...
              continuous efforts and achieved many outstanding achievements in vaccination activities, disease
              prevention, and has received the trust and love of tens of millions of people across the country for using
              its services. Vax-box has been honored for many consecutive years as the number 1 company in the top 10
              prestigious Vietnamese pharmaceutical companies (2023, 2024), in the distribution and trading of
              pharmaceuticals, medical equipment, and has been honored to receive a Certificate of Merit from the Prime
              Minister for its outstanding contributions to disease prevention. After nearly 10 years of accompanying
              the country's preventive medicine system to overcome all difficulties, rapidly promoting the development
              of the system to all regions of the country, especially remote areas, increasing access opportunities and
              vaccination rates in the community, Vax-box now has hundreds of vaccination centers across the country,
              striving to increase vaccination coverage rates to protect the health of children and adults with more
              than 11 million doses of various vaccines, preventing more than 40 dangerous infectious diseases.
              Particularly noteworthy is the effort to promote communication and education of the community about the
              role of vaccination for older children, adults, the elderly, people with underlying diseases, chronic
              diseases of the Vax-box vaccination system. Up to now, the rate of people aged 18 and over receiving all
              types of vaccines has reached over 40% of the total number of customers, contributing significantly to the
              care and protection of the health of workers and the elderly in the community.
            </p>
          </section>
          ...
          <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
            ...
            <p className='text-lg text-gray-700 mb-4 text-left'>
              ...
              person being vaccinated. This helps determine the ability to receive the vaccine, prevent unwanted risks
              and choose the most suitable vaccine. The doctor will also carefully advise on the benefits and side
              effects that may occur after vaccination.
            </p>
            <p className='text-lg text-gray-700 mb-4 text-left'>
              Pre-vaccination screening is an essential medical process that assesses general health status and
              identifies any risks that may affect the effectiveness or safety of a vaccine. It involves collecting
              detailed medical information, performing a physical examination, and performing necessary tests to ensure
              that there are no contraindications to vaccination.
            </p>
            <p className='text-lg text-gray-700 mb-4 text-left'>
            ...
            <p className='text-lg text-gray-700 mb-4 text-left'>
              Vaccination safety is not simply a matter of performing the injection technique correctly, but also
              includes a system of factors ensuring everything from vaccine storage to post-injection monitoring. When
              performed correctly, vaccination will provide the highest protection and minimize unwanted reactions. On
              the contrary, if safety principles are not followed, it can lead to many serious consequences, affecting
              the health of the vaccinated person, reducing public confidence in vaccination activities.
            </p>
            <p className='text-lg text-gray-700 mb-4 text-left'>
            ...
            <p className='text-lg text-gray-700 mb-4 text-left'>
              ...
              the VVM (Vaccine VialMonitor) -the temperature indicator on the vaccine vial to ensure that the vaccine
              has not been damaged by temperature. In the case of freeze-dried vaccines, reconstitution must be carried
              out in accordance with the manufacturer's instructions on the type of solvent, volume, and reconstitution
              technique.
            </p>
            <p className='text-lg text-gray-700 mb-4 text-left'>
              The injection site must be selected appropriately according to the type of vaccine and the age of the
              person being vaccinated. For children under 12 months of age, the injection site is usually the anterior
              outer thigh. For older children and adults, the injection can be in the deltoid muscle of the arm. The
              skin at the injection site must be disinfected with 70-degree alcohol or iodine alcohol, in a spiral from
              the inside out and allowed to dry naturally for 30 seconds.
            </p>
            <p className='text-lg text-gray-700 mb-4 text-left'>
              ...
              subcutaneous injection, the injection angle is 45 degrees and the needle depth must be appropriate for
              each subject. After completing the injection, the medical staff must quickly and firmly withdraw the
              needle, while gently pressing the injection site with a sterile dry cotton pad. Do not massage the
              injection site as this may increase the risk of local reactions. All used vaccination materials must be
              collected and disposed of in accordance with regulations on hazardous medical waste.
            </p>
            <p className='text-lg text-gray-700 mb-4 text-left'>
              The final step in the process is to record all information about the injection in the vaccination record.
              The information to be recorded includes the type of vaccine administered, dose, injection site, vaccine
              lot number and time of administration. This accurate recording is not only for monitoring and management
            ...
            <p className='text-lg text-gray-700 mb-4 text-left'>
              Post-vaccination monitoring is an essential part of ensuring vaccination safety. The vaccinated person
              needs to be monitored for at least 30 minutes at the vaccination facility to detect and promptly handle
              any reactions that may occur. The vaccination facility must have adequate equipment, emergency medicines
              and medical staff trained in handling post-vaccination reactions. The vaccinated person also needs to be
          ...
          <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
            ...
            <p className='text-lg text-gray-700 leading-relaxed mb-4'>
              ...
              infectious diseases for adults, including new generation vaccines and vaccines that are often scarce on
              the market.
            </p>
            <p className='text-lg text-gray-700 leading-relaxed mb-4'>
              With its prestige and many years of experience in implementing vaccination, Vax-box has become an
              official, comprehensive and important strategic partner with major vaccine companies in the world such as
              Glaxosmithkline - Belgium (GSK), Sanofi Pasteur (France), Pfizer (USA), Merck Sharp and Dohme (USA),
              AstraZeneca (UK), Sanofi (France), Abbott (Netherlands), Takeda (Japan) ... Therefore, Vax-box has the
              right to directly negotiate and import all types of vaccines for children and adults, helping people have
              full access to new generation vaccines, scarce vaccines and safe and reasonably priced vaccination
              services, contributing to increasing the vaccination rate, protecting the health of adults and the future
              of children.
            </p>
            <p className='text-lg text-gray-700 leading-relaxed mb-4'>
            ...
            />
            <p className='text-sm italic text-gray-700 text-center mt-4'>
              * Standard vaccine storage system, ensuring storage and preservation of vaccines in optimal conditions
          ...
          <section className='bg-white rounded-2xl shadow-2xl p-12 mb-10 w-full max-w-5xl'>
            ...
            <p className='text-lg text-gray-700 leading-relaxed mb-4'>
              The Vax-box vaccination center system is a vaccination unit in Vietnam that implements a closed 8-step
              safe vaccination process, ensuring that all vaccination steps are performed correctly and are strictly
              controlled to ensure maximum safety.
            </p>
            <p className='text-lg text-gray-700 leading-relaxed mb-4'>
              The team of doctors, nurses and medical staff are experienced and well-trained in the field of
              vaccination.
            </p>
            <p className='text-lg text-gray-700 leading-relaxed mb-4'>
