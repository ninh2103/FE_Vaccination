            ...
            <DialogContent className="sm:max-w-[550px]">
              ...
              <form onSubmit={handleSaveManufacturer}>
                ...
                <DialogFooter>
                  ...
                  <Button className="bg-gradient-to-r from-blue-400 via-green-500 to-teal-500 hover:from-blue-600 hover:to-green-600 font-semibold text-white" type="submit">{isEditMode ? "Update Manufacturer" : "Save Manufacturer"}</Button>
                </DialogFooter>
              </form>
            </DialogContent>
          </Dialog>
