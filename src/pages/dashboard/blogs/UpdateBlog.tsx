...
import { useUpdateBlogMutation } from '@/queries/useBlog'
...
export function UpdateBlog({ open, onOpenChange, onSubmit, blog }: UpdateBlogProps) {
  const { mutate: updateBlog, isPending: isUpdatingBlog } = useUpdateBlogMutation()
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className='sm:max-w-[700px] max-h-[90vh] overflow-y-auto'>
          <DialogHeader>
            ...
            <DialogDescription>Cập nhật bài viết blog bằng cách chỉnh sửa biểu mẫu bên dưới.</DialogDescription>
          </DialogHeader>
          <form onSubmit={form.handleSubmit(handleSubmit, handleFormError)} className='grid gap-4 py-4'>
            ...
            <DialogFooter>
              ...
              <Button type='submit' disabled={form.formState.isSubmitting || isUpdatingBlog}>
                {form.formState.isSubmitting || isUpdatingBlog ? 'Đang xử lý...' : 'Cập nhật bài viết'}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
