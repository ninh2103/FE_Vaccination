          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='text-left w-[300px]'>Nội dung</TableHead>
                <TableHead className='text-left w-[120px]'>Tag</TableHead>
                <TableHead className='text-center w-[120px]'>Ngày tạo</TableHead>
                <TableHead className='text-center w-[140px]'>Ngày cập nhật</TableHead>
