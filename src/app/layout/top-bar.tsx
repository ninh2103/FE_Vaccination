...
const Topbar: React.FC = () => {
  ...
  return (
    <div className='w-full bg-white  border-b border-gray-200 h-16 flex items-center justify-end px-4 shadow-sm'>
      {/* Right Section */}
        ...
        <DropdownMenu.Root>
          <DropdownMenu.Trigger asChild>
            ...
            >
              ...
              <span className='ml-2 text-sm font-medium text-gray-700 dark:text-gray-200 hidden md:inline'>Admin</span>
            </button>
          </DropdownMenu.Trigger>
